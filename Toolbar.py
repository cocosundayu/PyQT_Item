...
Date: 2024-11-19 19:43:54
LastEditors: sunke 375352086@qq.com
LastEditTime: 2024-11-20 16:24:56
FilePath: /PyQT_Practice/Toolbar.py
...
class Toolbar(QMainWindow):
    ...
    def initUI(self):
        ...
        # self  表示放在当前的窗口上
        # 工具栏默认按钮：只显示图标，将文本作为悬停提示展示
        new = QAction(QIcon('/Users/sunke/Downloads/孙科.jpg'),"new",self)
        # 添加new动作
        tb1.addAction(new)

        # 在工具栏添加第二个按钮
        open = QAction(QIcon('/Users/sunke/Downloads/孙科.jpg'),"open",self)
        # 添加open动作
        tb1.addAction(open)

        # 在工具栏添加第三个按钮
        save = QAction(QIcon('/Users/sunke/Downloads/孙科.jpg'),"save",self)
        tb1.addAction(save)
        ...
        # 往工具栏添加动作
        new1 = QAction(QIcon('/Users/sunke/Downloads/孙科.jpg'), "new1", self)
        # 添加new1动作
        tb2.addAction(new1)
