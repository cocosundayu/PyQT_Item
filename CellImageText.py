...
Date: 2024-11-21 11:17:09
LastEditors: sunke 375352086@qq.com
LastEditTime: 2024-11-21 11:22:00
FilePath: /PyQT_Practice/CellImageText.py
...
class CellImageText(QWidget):
    ...
    def initUI(self):
        ...
        newItem = QTableWidgetItem('sunke')
        # 把字段控件放到表格控件里  第一行第一列
        ...
        # 第四列添加图片
        newItem = QTableWidgetItem(QIcon('/Users/sunke/Downloads/孙科.jpg'),'背包')
